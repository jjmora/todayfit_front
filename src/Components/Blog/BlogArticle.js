      ...
      <div className="row">
        ...
        <div className="col-lg-8">
          <article>
            ...
            <figure className="mb-4">
              <img className="img-fluid rounded article-image-post" src={image1} alt="fitnees woman" />
            </figure>
        ...
        <div className="col-lg-4">
          ...
          <div className="card mb-4">
              ...
              <div className="card-body px-3">You can put anything you want inside of these side widgets. They are easy to use, and feature the Bootstrap 5 card component!</div>
          </div>
